...
Segons la informació facilitada per Meriem, alguns dels dies en què Jordi havia acabat abans de les 14 h es van registrar o regularitzar posteriorment com a festa. Això impedeix presentar-los automàticament com a temps no justificat, però no resol la qüestió organitzativa si aquesta situació no es va comunicar a l'equip quan es produïa. El problema que s'ha de contrastar no és només la sortida, sinó si Jordi avisava que marxava, si indicava si tornaria o si tindria festa, i si la resta podia saber en aquell moment si havia d'esperar-lo, continuar sense ell o reprogramar les tasques dependents. Cal identificar individualment quins dies es van regularitzar després i creuar-los amb el grup de WhatsApp i les aprovacions o canvis de Woffu.
