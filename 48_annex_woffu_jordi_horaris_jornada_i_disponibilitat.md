...
L'export actual de Woffu marca com a `Vacances` 41 dies de 2025: 4, 7 i 14 de febrer; 26, 27 i 31 de març; 2, **4**, 8, 9, 14, 15, 16, 17 i 30 d'abril; 16 de juliol; 5, 6, de l'11 al 14, del 18 al 22 i del 25 al 29 d'agost; i 1, 2, 4, 5, 12, 17, 18, 19 i 26 de setembre. El 04/04/2025 no figurava en la relació inicial facilitada, però l'export el marca també com a `Vacances` i mostra fitxatge de 09:41 a 14:07.

D'aquests 41 dies de vacances, **11 coincideixen** amb el recompte brut de dies amb sortides entre les 10 i les 14 h: 04/02, 07/02, 14/02, 31/03, 14/04, 15/04, 06/08, 04/09, 05/09, 17/09 i 18/09. Representen **12 sortides**, perquè el 14/02 n'hi ha dues. El 04/04 no s'afegeix a aquesta coincidència perquè la sortida consta a les 14:07, fora de la franja analitzada. Sis dels dies coincidents —04/02, 14/02, 04/09, 05/09, 17/09 i 18/09— també apareixen entre els 17 dies sense cap entrada posterior.

#### Proporció homogènia entre febrer i setembre de 2025

Entre l'01/02/2025 i el 30/09/2025 hi ha 172 dies de dilluns a divendres. No és correcte comparar aquest denominador amb els 54 dies del recompte global, perquè aquests 54 inclouen dates d'octubre i desembre de 2025, quatre dates de 2026 i caps de setmana. Dins del període febrer-setembre hi ha 46 dies bruts amb alguna sortida entre les 10 i les 14 h; 41 són de dilluns a divendres.

Per valorar específicament la franja obligatòria, el criteri més homogeni és la columna `Horari teòric` de Woffu i la data de l'acord. Entre el 04/02/2025 i el 30/09/2025 consten **123 dies amb jornada teòrica superior a zero**. En **29 d'aquests dies** hi ha alguna sortida entre les 10 i les 14 h. Això representa un **23,6 %**, aproximadament un de cada quatre dies amb jornada teòrica, no un terç.

Aquesta proporció tampoc acredita per si sola 29 incompliments: l'acord permetia sortir si s'avisava. Per tant, la formulació defensable és que en gairebé un de cada quatre dies amb jornada teòrica consta una interrupció dins la franja que requeria comprovar l'avís i coordinar la disponibilitat. Per afirmar incompliment cal creuar cadascuna de les 29 dates amb el grup de WhatsApp, permisos i comunicacions.

La rellevància organitzativa no es limita a Meriem. Una manca d'avís podia afectar Isa, Pablo, Adam o altres persones que depenguessin de Jordi per celebrar una reunió, validar materials, continuar una maquetació, programar continguts o complir una entrega. El creuament amb les tasques dependents ha de permetre identificar no només l'impacte sobre Meriem, sinó també els bloquejos o redistribucions que afectaven la resta de l'equip.

Segons Meriem, les 40 dates de la seva relació inicial es van agafar o registrar com a vacances posteriorment; encara no ha afirmat aquest extrem respecte del 04/04, detectat addicionalment a l'export. L'export acredita que les 41 dates consten actualment com a `Vacances`, però no mostra per si sol quan es van sol·licitar, aprovar o regularitzar; per acreditar que la qualificació va ser posterior cal l'historial de Woffu, comunicacions o testimonis. En qualsevol cas, la seva consideració final com a vacances impedeix presentar-los com a temps injustificat, però no resol la qüestió organitzativa si no es va informar l'equip en el moment de marxar. El problema que s'ha de contrastar no és només la sortida, sinó si Jordi avisava que marxava, si indicava si tornaria o si tindria vacances, i si la resta podia saber si havia d'esperar-lo, continuar sense ell o reprogramar les tasques dependents.
