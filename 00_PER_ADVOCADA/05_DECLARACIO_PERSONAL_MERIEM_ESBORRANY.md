# Declaracio Personal De Meriem - Esborrany
...
Aquest sistema no es va crear per evitar parlar amb ell, sino per reduir una carrega organitzativa que estava duplicant feina i per deixar constancia clara de terminis i enllacos.
...
La revisio sistematica de xarxes per part de Jordi es va incorporar sobretot arran de les seves queixes sobre publicacions amb faltes o sense revisio. Aixo va augmentar la meva feina organitzativa, perque havia de preparar avisos, recordatoris, enllacos, dates i sovint comprovar si havia contestat o no.
...
En ALBUM, el 07/10/2025 es va acordar no moure dates. Jordi va modificar el seguiment el 14/10/2025 del 13/10 al 27/10, quan la data del 13/10 ja havia passat. Aquesta modificacio no afectava nomes Jordi, perque condicionava la feina posterior d'Isa, la meva i la resta del proces d'elaboracio.

**Annexos a citar:** acta 07/10, historial ALBUM, correu Pablo 15/10, respostes Isa/Adam/Jordi.

### 8. Relacio Professional Despres Dels Conflictes
...
- "Jordi menteix" com a formula general.
- "Ho feia expressament" si no hi ha prova directa d'intencionalitat.
- Referencies a diagnostics o causes mediques del seu malestar.
- Converses personals no necessaries per acreditar els fets laborals.

## Formulacio Final Recomanada
